...
- **Contract & Unit Tests**: 65 tests across 17 suites (`node:test`) verifying mock API contracts, model normalization, optimistic sending reconciliation, pin retention, error mapping, and geometry crop calculations.
